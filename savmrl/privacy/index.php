...
<main>
    <div class="horizontal-center">
        ...
        <br>
        <p class="horizontal-center-p basic">
            savmrl.it doesn't collect any your personal data or information.
            <br>
            The service collects only the data (link, etc.) you insert and your public IP address.
        </p>
    </div>
