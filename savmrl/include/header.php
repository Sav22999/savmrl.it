...
$title_header = "<a href='/' id='title-page-with-icon'><img src='/savmrl/images/icon-big.svg'/><div class='text'>savmrl.it</div></a>"; //TODO : set manually //<span style='color: teal;font-family: serif'>αlpha</span>
